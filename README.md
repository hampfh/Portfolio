...
- `--color-dark`: The dark color of the theme
- `--color-light`: The light color of the theme
- `--color-dark-muted`: The dark color of the theme with a slight opacity
- `--color-light-muted`: The light color of the theme with a slight opacity
- `--color-accent-light`: The light accent color of the theme
- `--color-accent-light-muted`: The light accent color of the theme with a slight opacity
- `--color-accent-dark`: The dark accent color of the theme
- `--color-accent-dark-muted`: The dark accent color of the theme with a slight opacity
